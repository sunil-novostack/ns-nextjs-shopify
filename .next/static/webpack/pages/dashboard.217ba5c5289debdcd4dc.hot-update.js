      ...
      try {
        var response = axios__WEBPACK_IMPORTED_MODULE_12___default()({
          ...
          response.data.settings ? _this2.setState({
            settings: response.data.settings.priceRules
          }) : _this2.setState({
            priceRules: {
              pricehikeconditional: '*',
              productPriceHike: '2'
