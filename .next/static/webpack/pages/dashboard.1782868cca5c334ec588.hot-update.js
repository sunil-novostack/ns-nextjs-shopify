                    ...
                    if (response.data.productDetail.variants) {
                      response.data.productDetail.variants.map(function (variant, index) {
                        if (variant.price == null) {
                          ...
                          variant.price = Number(variant.price.toString().replace('$', ''));
                        }
